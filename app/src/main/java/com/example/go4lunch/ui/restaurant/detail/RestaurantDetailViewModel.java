...
public class RestaurantDetailViewModel extends ViewModel {
    ...
    public RestaurantDetailViewModel(
        ...
        restaurantId = savedStateHandle.get(RestaurantDetailsActivity.KEY_RESTAURANT_ID);
    ...
    private void combine(
        ...
        if (detailsRestaurantWrapper instanceof DetailsRestaurantWrapper.RequestError) {
            if (((DetailsRestaurantWrapper.RequestError) detailsRestaurantWrapper).getThrowable().getMessage() != null) {
                restaurantDetailViewStateMediatorLiveData.setValue(
                    new RestaurantDetailViewState.Error(
                        ((DetailsRestaurantWrapper.RequestError) detailsRestaurantWrapper).getThrowable().getMessage()
                    )
                );
            }
        }
