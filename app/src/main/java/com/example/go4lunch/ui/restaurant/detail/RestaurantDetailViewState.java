...
public abstract class RestaurantDetailViewState {
    ...
    public static class RestaurantDetail extends RestaurantDetailViewState {
        ...
        public boolean equals(Object o) {
            ...
            return id.equals(that.id) && name.equals(that.name) && vicinity.equals(that.vicinity) &&
                Objects.equals(pictureUrl, that.pictureUrl) && rating.equals(that.rating) &&
                Objects.equals(phoneNumber, that.phoneNumber) && Objects.equals(websiteUrl, that.websiteUrl) &&
                attendanceState == that.attendanceState && restaurantDetailsFavoriteState == that.restaurantDetailsFavoriteState &&
                isPhoneNumberAvailable.equals(that.isPhoneNumberAvailable) && isWebsiteAvailable.equals(that.isWebsiteAvailable);
        }
